...
"""Installer for the visaplan.zope.inputmacros package."""
...
package_name = 'visaplan.zope.inputmacros'
...
# see as well --> src/visaplan/zope/inputmacros/configure.zcml:
exclude_subpackages = (
        )
exclude_packages = []
...
setup_kwargs = dict(
    name=package_name,
    version=VERSION,
    description="Generic METAL macros for input fields",
